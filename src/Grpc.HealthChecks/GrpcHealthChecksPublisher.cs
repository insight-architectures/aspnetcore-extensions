...
{
    /// <summary>
    /// An implementation of <see cref="IHealthCheckPublisher" />.
    /// </summary>
    public class GrpcHealthChecksPublisher : IHealthCheckPublisher
    {
        ...
        /// <summary>
        /// Creates an instance of <see cref="GrpcHealthChecksPublisher" />.
        /// </summary>
        /// <param name="healthService">The service to query to check the health of the service.</param>
