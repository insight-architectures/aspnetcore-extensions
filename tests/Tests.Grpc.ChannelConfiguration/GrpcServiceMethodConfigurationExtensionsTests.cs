...
public class GrpcServiceMethodConfigurationExtensionsTests
{
    ...
    public class ConfigureServiceMethods
    {
        ...
        public void ConfigureServiceMethods_does_nothing_if_no_configuration_is_added(string serviceName, string methodName, ConfigurationBuilder configurationBuilder, ServiceCollection services, Uri uri)
        {
        ...
        [Test, CustomAutoData]
        public void ConfigureServiceMethods_can_set_fallback_retry_configuration(ConfigurationBuilder configurationBuilder, ServiceCollection services, Uri uri, RetryPolicy retryPolicy, StatusCode statusCode)
        {
        ...
        [Test, CustomAutoData]
        public void ConfigureServiceMethods_can_set_fallback_hedging_configuration(ConfigurationBuilder configurationBuilder, ServiceCollection services, Uri uri, HedgingPolicy hedgingPolicy, StatusCode statusCode)
        {
        ...
        [Test, CustomAutoData]
        public void ConfigureServiceMethods_throws_if_fallback_configuration_has_both_retry_policy_and_hedging_policy(ConfigurationBuilder configurationBuilder, ServiceCollection services, Uri uri, RetryPolicy retryPolicy, HedgingPolicy hedgingPolicy, StatusCode statusCode)
        {
            retryPolicy.RetryableStatusCodes.Add(statusCode);
        ...
        [Test, CustomAutoData]
        public void ConfigureServiceMethods_can_set_set_retry_policy_for_service(ConfigurationBuilder configurationBuilder, ServiceCollection services, Uri uri, RetryPolicy retryPolicy, StatusCode statusCode, string serviceName)
        {
            retryPolicy.RetryableStatusCodes.Add(statusCode);
        ...
        [Test, CustomAutoData]
        public void ConfigureServiceMethods_can_set_set_hedging_policy_for_service(ConfigurationBuilder configurationBuilder, ServiceCollection services, Uri uri, HedgingPolicy hedgingPolicy, StatusCode statusCode, string serviceName)
        {
            hedgingPolicy.NonFatalStatusCodes.Add(statusCode);
        ...
        [Test, CustomAutoData]
        public void ConfigureServiceMethods_throws_if_service_configuration_has_both_retry_policy_and_hedging_policy(ConfigurationBuilder configurationBuilder, ServiceCollection services, Uri uri, RetryPolicy retryPolicy, HedgingPolicy hedgingPolicy, StatusCode statusCode, string serviceName)
        {
            retryPolicy.RetryableStatusCodes.Add(statusCode);
        ...
        [Test, CustomAutoData]
        public void ConfigureServiceMethods_can_set_retry_policy_for_method(ConfigurationBuilder configurationBuilder, ServiceCollection services, Uri uri, RetryPolicy retryPolicy, StatusCode statusCode, string serviceName, string methodName)
        {
            retryPolicy.RetryableStatusCodes.Add(statusCode);
        ...
        [Test, CustomAutoData]
        public void ConfigureServiceMethods_can_set_hedging_policy_for_method(ConfigurationBuilder configurationBuilder, ServiceCollection services, Uri uri, HedgingPolicy hedgingPolicy, StatusCode statusCode, string serviceName, string methodName)
        {
            hedgingPolicy.NonFatalStatusCodes.Add(statusCode);
        ...
        [Test, CustomAutoData]
        public void ConfigureServiceMethods_throws_if_service_configuration_has_both_retry_policy_and_hedging_policy(ConfigurationBuilder configurationBuilder, ServiceCollection services, Uri uri, RetryPolicy retryPolicy, HedgingPolicy hedgingPolicy, StatusCode statusCode, string serviceName, string methodName)
        {
            retryPolicy.RetryableStatusCodes.Add(statusCode);
    ...
    public class ConfigureServiceMethod
    {
        ...
        [CustomInlineAutoData(null!)]
        [CustomInlineAutoData]
        public void ConfigureServiceMethod_can_configure_method_retry_policy_from_configuration(string methodName, string serviceName, ConfigurationBuilder configurationBuilder, ServiceCollection services, Uri uri, RetryPolicy retryPolicy, StatusCode statusCode)
        {
        ...
        [CustomInlineAutoData(null!)]
        [CustomInlineAutoData]
        public void ConfigureServiceMethod_can_configure_method_hedging_policy_from_configuration(string methodName, string serviceName, ConfigurationBuilder configurationBuilder, ServiceCollection services, Uri uri, HedgingPolicy hedgingPolicy, StatusCode statusCode)
        {
            var method = new MethodName { Service = serviceName, Method = methodName };
        ...
        [CustomInlineAutoData(null!)]
        [CustomInlineAutoData]
        public void ConfigureServiceMethod_throws_if_service_configuration_has_both_retry_policy_and_hedging_policy(string methodName, string serviceName, ConfigurationBuilder configurationBuilder, ServiceCollection services, Uri uri, RetryPolicy retryPolicy, HedgingPolicy hedgingPolicy, StatusCode statusCode)
        {
            var method = new MethodName { Service = serviceName, Method = methodName };
        ...
        [CustomInlineAutoData(null!)]
        [CustomInlineAutoData]
        public void ConfigureServiceMethod_can_configure_method_retry_policy_from_policy(string methodName, string serviceName, ServiceCollection services, Uri uri, RetryPolicy retryPolicy, StatusCode statusCode)
        {
            var method = new MethodName { Service = serviceName, Method = methodName };
            ...
            builder.ConfigureServiceMethod(method, retryPolicy);
        ...
        [CustomInlineAutoData(null!)]
        [CustomInlineAutoData]
        public void ConfigureServiceMethod_can_configure_method_hedging_policy_from_policy(string methodName, string serviceName, ServiceCollection services, Uri uri, HedgingPolicy hedgingPolicy, StatusCode statusCode)
        {
            var method = new MethodName { Service = serviceName, Method = methodName };
            ...
            builder.ConfigureServiceMethod(method, hedgingPolicy);
        ...
        [CustomInlineAutoData(null!)]
        [CustomInlineAutoData]
        public void ConfigureServiceMethod_can_configure_string_method_retry_policy_from_policy(string methodName, string serviceName, ServiceCollection services, Uri uri, RetryPolicy retryPolicy, StatusCode statusCode)
        {
            var method = CreateMethodNameString(serviceName, methodName);
        ...
        [CustomInlineAutoData(null!)]
        [CustomInlineAutoData]
        public void ConfigureServiceMethod_can_configure_string_method_hedging_policy_from_policy(string methodName, string serviceName, ServiceCollection services, Uri uri, HedgingPolicy hedgingPolicy, StatusCode statusCode)
        {
            var method = CreateMethodNameString(serviceName, methodName);
    ...
    [TestOf(nameof(GrpcServiceMethodConfigurationExtensions.ConfigureDefaultServiceMethod))]
    public class ConfigureDefaultServiceMethod
    {
        ...
        [Test, CustomAutoData]
        public void ConfigureDefaultServiceMethod_can_set_fallback_retry_configuration(ConfigurationBuilder configurationBuilder, ServiceCollection services, Uri uri, RetryPolicy retryPolicy, StatusCode statusCode)
        {
            retryPolicy.RetryableStatusCodes.Add(statusCode);
            ...
            var builder = services.AddGrpcClient<TestGrpcClient>(o => o.Address = uri).ConfigureDefaultServiceMethod(configuration.GetSection("GRPC"));
        ...
        [Test, CustomAutoData]
        public void ConfigureDefaultServiceMethod_can_set_fallback_hedging_configuration(ConfigurationBuilder configurationBuilder, ServiceCollection services, Uri uri, HedgingPolicy hedgingPolicy, StatusCode statusCode)
        {
            hedgingPolicy.NonFatalStatusCodes.Add(statusCode);
        ...
        [Test, CustomAutoData]
        public void ConfigureDefaultServiceMethod_throws_if_fallback_configuration_has_both_retry_policy_and_hedging_policy(ConfigurationBuilder configurationBuilder, ServiceCollection services, Uri uri, RetryPolicy retryPolicy, HedgingPolicy hedgingPolicy, StatusCode statusCode)
        {
            retryPolicy.RetryableStatusCodes.Add(statusCode);
            ...
            Assert.That(() => builder.ConfigureDefaultServiceMethod(configuration.GetSection("GRPC")), Throws.ArgumentException);
        }    

        [Test, CustomAutoData]
        public void ConfigureDefaultServiceMethod_can_set_fallback_retry_policy(ServiceCollection services, Uri uri, RetryPolicy retryPolicy, StatusCode statusCode)
        {
            retryPolicy.RetryableStatusCodes.Add(statusCode);

            var builder = services.AddGrpcClient<TestGrpcClient>(o => o.Address = uri);

            builder.ConfigureDefaultServiceMethod(retryPolicy);
        ...
        [Test, CustomAutoData]
        public void ConfigureDefaultServiceMethod_can_set_fallback_hedging_policy(ServiceCollection services, Uri uri, HedgingPolicy hedgingPolicy, StatusCode statusCode)
        {
            hedgingPolicy.NonFatalStatusCodes.Add(statusCode);

            var builder = services.AddGrpcClient<TestGrpcClient>(o => o.Address = uri);

            builder.ConfigureDefaultServiceMethod(hedgingPolicy);
